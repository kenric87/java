...
public class Ch10_Part1 {
	public static void main(String[] args) {		
		...
		System.out.println(a.indexOf('讚', 0));//8
		System.out.println(a.lastIndexOf('讚', 10));//10
		
		// (3) int indexOf(String str)
		System.out.println(a.indexOf("測試"));//4
		System.out.println(a.indexOf("字符"));//-1
		System.out.println(a.indexOf("讚讚"));//8
		System.out.println(a.lastIndexOf("讚讚讚"));//8
		
		// (4) int indexOf(String str, int fromIndex)
		System.out.println(a.indexOf("讚讚", 9));
		System.out.println(a.lastIndexOf("串讚讚",7));
		...
		System.out.println(a.substring(6, 8));//字串
